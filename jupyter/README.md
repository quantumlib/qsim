# Quantum simulation _on _GCP with _cirq_ and _qsim _
...
# **Table of Contents**
  ...
  * [**Creating a GCE VM**  {#creating-a-gce-vm}](#creating-a-gce-vm----creating-a-gce-vm-)
    + [Use the Cloud Console {#use-the-cloud-console}](#use-the-cloud-console---use-the-cloud-console-)
    + [Build a Container Optimized VM {#build-a-container-optimized-vm}](#build-a-container-optimized-vm---build-a-container-optimized-vm-)
  * [**Running the qsim docker container** {#running-the-qsim-docker-container}](#running-the-qsim-docker-container---running-the-qsim-docker-container-)
    + [Open a SSH window to your VM {#open-a-ssh-window-to-your-vm}](#open-a-ssh-window-to-your-vm---open-a-ssh-window-to-your-vm-)
  * [**Run interactively: "Hello Qubit"** {#run-interactively-"hello-qubit"}](#run-interactively---hello-qubit----run-interactively--hello-qubit--)
    + [Build the circuit {#build-the-circuit}](#build-the-circuit---build-the-circuit-)
    + [Run the circuit {#run-the-circuit}](#run-the-circuit---run-the-circuit-)
    + [Running your own script {#running-your-own-script}](#running-your-own-script---running-your-own-script-)
    + [Exit the container {#exit-the-container}](#exit-the-container---exit-the-container-)
  * [**Cleaning up** {#cleaning-up}](#--cleaning-up-----cleaning-up-)
    + [Delete the VM {#delete-the-vm}](#delete-the-vm---delete-the-vm-)
    + [Delete the project {#delete-the-project}](#delete-the-project---delete-the-project-)
...
*   Choose a Region and Zone
    *   The values are not too important now, but for latency and availability [you may make different choice](https://cloud.google.com/compute/docs/regions-zones).
...
## Run interactively: "Hello Qubit" {#run-interactively-"hello-qubit"}
...
*   [https://cirq.readthedocs.io/en/stable/examples.html](https://cirq.readthedocs.io/en/stable/examples.html)
*   [https://github.com/quantumlib/qsim/blob/master/docs/tutorials/qsimcirq.ipynb](https://github.com/quantumlib/qsim/blob/master/docs/tutorials/qsimcirq.ipynb)
